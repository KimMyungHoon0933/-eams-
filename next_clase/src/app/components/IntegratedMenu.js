...
export default function IntegratedMenu({
  ...
  const routeMap = {
    // 휴·복학
    "휴학 > 휴학 신청": "/Integrated/leave_request",
    "휴학 > 복학 신청": "/Integrated/back_school",

    "출석 > 출석입력": "/Integrated/attendance-input",
    "휴학 > 복학 신청": "/Integrated/back_school",

    // 성적처리 (조회)
    "성 적 > 성적처리 > 금학기 성적 조회(미관점)": "/Integrated/grades/current",
    "성 적 > 성적처리 > 기이수성적조회": "/Integrated/grades/history",

    // 성적입력
    "성 적 > 성적입력 > 성적입력": "/Integrated/grades-input",
    "성 적 > 성적입력 > 성적출력": "/Integrated/grade_export",
