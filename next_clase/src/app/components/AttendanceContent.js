      ...
      <main className={styles.main}>
        ...
        <section className={styles.grid}>
          ...
          <div className={styles.cardsContainer}>
                <AttendanceCard student={{ name: '홍길동', id: '20241234', major: '컴퓨터소프트웨어학과' }} />
                <AttendanceCard student={{ name: '이순신', id: '20241235', major: '컴퓨터소프트웨어학과' }} />
                <AttendanceCard student={{ name: '김철수', id: '20241236', major: '컴퓨터소프트웨어학과' }} />
            </div>
