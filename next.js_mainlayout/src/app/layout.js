  ...
  return (
    <html lang="ko">
      <head>
        ...
        <link rel="javascript" href="/assest/js/timetable.js"/>
      </head>
      <body>
        <div className="greenLayout">
          ...
          <div className="navbar">
              ...
              <div className="search-icon" title="검색">
        ...
        <div className="card">  
          ...
          <ul className="notice-list">
            ...
            <li className="notice-item">
              <div className="title">
                <span className="bullet"></span>
                [동서울대학교]2025 겨울방학 동서울울 글쓰기 지도 프로그램 신청
              </div>
            ...
            <li className="notice-item">
              <div className="title">
                <span className="bullet"></span>
                [동서울]2025년 겨울방학 글쓰기 능력 향상 프로그램 신청안내
              </div>
        ...
        <div className="card"> 
          ...
          <ul className="news-list">
            <li className="news-item">
              <div className="title">
                <span className="bullet3"></span>
                [동동자료료]2025학년도 1학기 동서울대⋯
              </div>
            </li>
            <li className="news-item">
              <div className="title">
                <span className="bullet3"></span>
                [동동자료]제63회 장학금 수기 공모전 ⋯
              </div>
            </li>
            <li className="news-item">
              <div className="title">
                <span className="bullet3"></span>
                [동동자료]2025년 1학기 ‘동동서울대학교 ⋯
              </div>
            </li>
            <li className="news-item">
              <div className="title">
                <span className="bullet3"></span>
                [뉴스]20년 연속 동서울대학교 수상상
              </div>
            </li>
            <li className="news-item">
              <div className="title">
                <span className="bullet3"></span>
                [뉴스]동서울대학교 운동장 잔디 모두 교체체
              </div>
            </li>
            <li className="news-item">
              <div className="title">
    ...
    <div className="card">
          ...
          <script src="assest/js/calendar.js"></script>
    </div>
        ...
        <script src="/assest/js/timetable.js" strategy="afterInteractive" />
        <script src="/assest/js/calendar.js" strategy="afterInteractive" />
      </body>
    </html>
